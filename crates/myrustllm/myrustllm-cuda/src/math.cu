...
void cuda_tensor_copy_f32(
    ...
    size_t* a_strides_cuda, *out_strides_cuda, *shape_cuda;
    ...
    LAUNCH_KERNEL(elementwise_copy_kernel<float>, 32, 512, a, out, a_strides_cuda, out_strides_cuda, shape_cuda, n_dims, n_elements);
...
void cuda_tensor_sub_f32(
    ...
    LAUNCH_KERNEL(elementwise_sub_kernel<float>, 32, 512, a, b, out, a_strides_cuda, b_strides_cuda, out_strides_cuda, shape_cuda, n_dims, n_elements);
...
void cuda_tensor_mul_f32(
    ...
    LAUNCH_KERNEL(elementwise_mul_kernel<float>, 32, 512, a, b, out, a_strides_cuda, b_strides_cuda, out_strides_cuda, shape_cuda, n_dims, n_elements);
...
void cuda_tensor_div_f32(
    ...
    LAUNCH_KERNEL(elementwise_div_kernel<float>, 32, 512, a, b, out, a_strides_cuda, b_strides_cuda, out_strides_cuda, shape_cuda, n_dims, n_elements);
...
void cuda_tensor_neg_f32(
    ...
    LAUNCH_KERNEL(elementwise_neg_kernel<float>, 32, 512, a, out, a_strides_cuda, out_strides_cuda, shape_cuda, n_dims, n_elements);
