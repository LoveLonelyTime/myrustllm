...
void tensor_binary_op_impl(CPUTensor &out, CPUTensor &lhs, CPUTensor &rhs, Op op)
{
...
void tensor_binary_op(CPUTensor &out, CPUTensor &lhs, CPUTensor &rhs, Op &&op, DType dtype)
{
    switch (dtype)
    {
    case DT_F32:
